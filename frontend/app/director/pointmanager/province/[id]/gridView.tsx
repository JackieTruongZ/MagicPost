...
import { PointForm } from '@/public/utils/interface';
...
const GridView = ({ pointType, point }: Props) => {
    ...
    const itemTemplate = (point: PointForm) => {
        return (
            <div className='col-12 md:col-6 lg:col-4 cursor-pointer' onClick={()=>{window.location.href = `/director/pointmanager/point/${pointType}/${point.id}`}}>
